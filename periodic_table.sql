...
--
-- Name: properties foreign_num; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT foreign_num FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
